...
#define EI_CLASSIFIER_TFLITE_LEARN_8_ARENA_SIZE     10624
const size_t tflite_learn_8_arena_size = 10624;

INCBIN(incbin_tflite_learn_8, "tflite-model/tflite_learn_8.tflite");

const unsigned char *tflite_learn_8 = gincbin_tflite_learn_8_data;
unsigned int tflite_learn_8_len = gincbin_tflite_learn_8_size;
